...
const ForgotPasswordPage = () => {
  ...
  useEffect(() => {
    console.log("Form state:", { isSubmitted, isLoading, error });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setIsSubmitted((prev) => {
        console.log("Updating isSubmitted from:", prev, "to: true");
        return true;
      });
      setEmail("");
    } catch (error) {
    ...
    <div className="flex items-center justify-center min-h-screen">
      ...
      >
          ...
          {!isSubmitted ? (
            ...
            <div className="text-center">
              <motion.div
                ...
                className="w-16 h-16 bg-sky-800 rounded-full flex items-center justify-center mx-auto mb-4"
              >
        ...
        <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
          <Link
            to={"/login"}
            className="text-sm over:underline flex items-center"
          >
